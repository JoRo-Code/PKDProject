...
{- animationFunc time game
    ...
    RETURNS: game with new angle of radarAnimation, and new radius and derivative for shootingAnimation
             and whether or not shootingAnimation should be shown with respect to time
    EXAMPLES:
